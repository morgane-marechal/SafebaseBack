...
ALTER TABLE IF EXISTS ONLY public.favoris DROP CONSTRAINT IF EXISTS favoris_id_user_fkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.plantes DROP CONSTRAINT IF EXISTS plantes_pkey;
ALTER TABLE IF EXISTS ONLY public.favoris DROP CONSTRAINT IF EXISTS favoris_pkey;
ALTER TABLE IF EXISTS public.users ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.plantes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.favoris ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.users_id_seq;
DROP TABLE IF EXISTS public.users;
DROP SEQUENCE IF EXISTS public.plantes_id_seq;
DROP TABLE IF EXISTS public.plantes;
DROP TABLE IF EXISTS public.musique_pour_plante;
DROP SEQUENCE IF EXISTS public.favoris_id_seq;
DROP TABLE IF EXISTS public.favoris;
