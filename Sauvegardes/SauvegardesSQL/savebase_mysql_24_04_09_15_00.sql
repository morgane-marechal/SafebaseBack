...
CREATE TABLE `users` (
  ...
  `login` varchar(255) CHARACTER SET utf16 COLLATE utf16_bin NOT NULL,
...
INSERT INTO `users` VALUES (1,'lili','Lili','azerty','az@gmail.com'),(2,'zoom','zoom','azerty','zoom@gmail.com'),(3,'zoom1','zoom1','azerty','zoom1@gmail.com');
...
-- Dump completed on 2024-09-04 13:00:49
