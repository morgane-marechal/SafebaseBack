...
ALTER TABLE IF EXISTS ONLY public.backup_liste DROP CONSTRAINT IF EXISTS backup_liste_database_id_fkey;
ALTER TABLE IF EXISTS ONLY public.database_liste DROP CONSTRAINT IF EXISTS database_liste_pkey;
ALTER TABLE IF EXISTS ONLY public.backup_liste DROP CONSTRAINT IF EXISTS backup_liste_pkey;
ALTER TABLE IF EXISTS public.database_liste ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.backup_liste ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.database_liste_id_seq;
DROP TABLE IF EXISTS public.database_liste;
DROP SEQUENCE IF EXISTS public.backup_liste_id_seq;
DROP TABLE IF EXISTS public.backup_liste;
...
1	postgres	Sauvegardes/SauvegardesPosteGres/savebase_postgres_24_17_09_13_45.sql	\N	1
\.
...
1	dev	pass	localhost	1233	postgres	dev	safebaseback-postgres_database_dev-1
\.
